...
public class ProductActivity extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (myProduct != null) {
			...
			firstWeight.setText(Double.toString(myProduct.getPacks().get(0)
					.getWeight())
					+ " ");
			...
			try {
				...
				secondNumber.setText(Integer.toString(myProduct.getPacks()
						.get(1).getNumber())
						+ " ");

				TextView secondWeight = (TextView) findViewById(R.id.weightTwo);
				secondWeight.setText(Double.toString(myProduct.getPacks()
						.get(1).getWeight())
						+ " ");
				...
				thirdNumber.setText(Integer.toString(myProduct.getPacks()
						.get(2).getNumber())
						+ " ");

				TextView thirdWeight = (TextView) findViewById(R.id.weightThree);
				thirdWeight.setText(Double.toString(myProduct.getPacks().get(2)
						.getWeight())
						+ " ");
